...
"""
from sqlalchemy.orm import sessionmaker, declarative_base   #modern SQLAlchemy 2.0 import
from config import settings #import settings form config.py
...
"""
engine = create_engine(settings.database_url)   #now reads DATABSE_URL from .env
